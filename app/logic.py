...
from scipy.interpolate import griddata   # << ใช้แค่นี้พอ
...
def compute_overlay_from_event(ev: dict):
    ...
    PGA_S = _pga_cy08_at_points(mag, depth, lat, lon, LAT_S, LON_S)
        ...
        # -------------------- Interpolation (griddata เท่านั้น) --------------------
